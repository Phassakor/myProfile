...
import { SiNextdotjs, SiTailwindcss, SiTypescript, SiFigma, SiJavascript } from 'react-icons/si';
  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
        ...
        {/* About Content */}
        <motion.div custom={2} variants={fadeUp} className="space-y-6 text-left">
          <h3 className="text-2xl font-semibold">I'm a Frontend Developer 👨‍💻</h3>
          <p className="">
            สวัสดีครับ ผมเป็น Frontend Dev ที่ชื่นชอบการสร้าง UI ที่ทั้งสวยงามและใช้งานได้จริง
            มีความหลงใหลในการใช้เทคโนโลยีสมัยใหม่เช่น React, Next.js, TailwindCSS และ TypeScript
            เพื่อสร้างเว็บไซต์ที่ทันสมัยและประสิทธิภาพสูง
          </p>
          <p className="">
            ผมเชื่อในงานออกแบบที่ใส่ใจในรายละเอียด การเขียนโค้ดที่สะอาด และการเรียนรู้ที่ไม่หยุดนิ่ง
          </p>
        </motion.div>
      </div>
